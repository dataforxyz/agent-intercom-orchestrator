...
export const DEFAULT_CONFIG: OrchestratorConfig = {
  ...
  terminalCacheRetentionMinutes: 60,
  terminalRuntimeRetentionMinutes: 7 * 24 * 60,
...
export function mergeConfig(value: unknown): OrchestratorConfig {
  ...
  return {
    ...
    terminalCacheRetentionMinutes: positiveNumber(value.terminalCacheRetentionMinutes, DEFAULT_CONFIG.terminalCacheRetentionMinutes),
    terminalRuntimeRetentionMinutes: positiveNumber(value.terminalRuntimeRetentionMinutes, DEFAULT_CONFIG.terminalRuntimeRetentionMinutes),
...
export async function writeConfigDefaults(path: string, config: OrchestratorConfig): Promise<void> {
  ...
  await writeConfigValue(path, {
    ...
    terminalCacheRetentionMinutes: config.terminalCacheRetentionMinutes,
    terminalRuntimeRetentionMinutes: config.terminalRuntimeRetentionMinutes,
