...
- Add explicit Boss create requirements for worktree, edit, test, and Git transport needs, with pre-mutation fail-closed capability-gap reports that distinguish verified facts from configured policy.
